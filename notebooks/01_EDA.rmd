...
- From the above, we see that the differenced household and corporate net saving rates appear to be stationary based on the ADF test and the visual diagnostics. 
...
ccf(na.omit(eda_df$ldgpdi), na.omit(eda_df$dcorp_rate),
    main = "GPDI vs corp saving rate")
